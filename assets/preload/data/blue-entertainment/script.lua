...
function onStepHit()
    if curStep == 112 then
		...
		doTweenAlpha('threeAlpha', 'three', 0, 0.50, 'cubeOut');
end

    if curStep == 115 then
		setProperty('two.visible', true)
		doTweenAlpha('twoAlpha', 'two', 0, 0.50, 'cubeOut');
end

    if curStep == 120 then
		setProperty('gofun.visible', true)
		doTweenAlpha('gofunAlpha', 'gofun', 0, 0.50, 'cubeOut');
end
	...
	if curStep == 1165 then
		...
		doTweenAlpha('gofunAlpha', 'gofun2', 0, 0.50, 'cubeOut');
   end
 end
end