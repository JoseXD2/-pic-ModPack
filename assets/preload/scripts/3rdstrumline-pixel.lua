...
function onCreatePost()
	...
	for i = 4,7 do
		setPropertyFromGroup('strumLineNotes', i, 'x', 710 + (95 * (i % 4)))
	end
	...
	for i=1, #directions do
		makeAnimatedLuaSprite('strum'..directions[i], 'BlueNOTES', getPropertyFromGroup('opponentStrums', i-1, 'x') - 140, defaultstrumy - 100)
